    ...
    <div className="citizen-card-shell neuro-page-shell" style={{ flexDirection: 'column' }}>
      ...
      <div className={`walking-content-container neuro-content-container ${transitState}`} style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="neuro-deck-layout">
          ...
          {/* RIGHT COLUMN: Sleek Persistent Telemetry & Navigation Cockpit */}
          <div className="neuro-right-col custom-scroll">
            
            {/* Sector Telemetry and Coordinates Card */}
            <div className="bubbly-panel" style={{ flexShrink: 0 }}>
              <h4 style={{ fontFamily: 'var(--font-tech)', fontSize: '0.72rem', color: '#00ff88', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '8px' }}>
                🛰️ Sector Telemetry
              </h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontFamily: 'monospace', fontSize: '0.62rem', color: 'rgba(255,255,255,0.7)' }}>
                <div>
                  <strong style={{ color: '#00ff88' }}>LOCATION:</strong> ADVOCACY HUB // SECTOR 02
                </div>
                <div>
                  <strong style={{ color: '#00ff88' }}>COORDS:</strong> X: 150 / Y: -100
                </div>
                <div>
                  <strong style={{ color: '#00ff88' }}>TRANSIT:</strong> 180m walk from CITIZEN SUITE
                </div>
                <div>
                  <strong style={{ color: '#00ff88' }}>GRID STATUS:</strong> ONLINE_NOMINAL
                </div>
              </div>
            </div>
            ...
            {/* Quick-Return Cockpit Bridge */}
            <div className="bubbly-panel" style={{ flexShrink: 0, padding: '16px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <h4 style={{ fontFamily: 'var(--font-tech)', fontSize: '0.72rem', color: '#00ff88', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0 }}>
                🚀 Workspace Return Bridge
              </h4>
              <p style={{ fontSize: '0.62rem', color: 'var(--text-secondary)', lineHeight: 1.4, margin: 0 }}>
                Teleport directly back to the main cockpit dashboard interface to manage other orbital tasks:
              </p>
